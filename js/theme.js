...
jQuery(function($) {
	...
	$('#jx-main-menu,#jx-main-menu-2').slicknav();
});
	...
	var Theme = {
		...
		onReady: function(){				
			...
			jQuery(document).ready(function(){				
				...
				//Mobile Menu
				jQuery('.slicknav_nav li.has-child > ul').children().unwrap();
				jQuery('.slicknav_nav li.has-child').children().unwrap();
